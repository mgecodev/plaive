<footer class="footer">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-xs-12">
                <div class="widget clearfix">
                    ...
                    <p> 메이커 컨텐츠를 제공하고 학습 관리 시스템을 서비스하는 메직에코입니다.</p>
            ...
            <div class="col-lg-6 col-md-6 col-xs-12">
                <div class="widget clearfix">
                    ...
                    <ul class="footer-links">
                        ...
                        <li>서울특별시 성동구 성수일로 10길 26. 하우스디세종타워 1505호</li>
                        <li>Fax. 02.6455.9167</li>
                    </ul><!-- end links -->
                </div><!-- end clearfix -->
            </div><!-- end col -->
    ...
    <!-- large modal -->
    <div class="modal fade bs-example-modal-lg" id="Large-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="Medium-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer" id="medium-modal-button">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <div class="modal fade" id="small-modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer" id="small-modal-button">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content bg-danger text-white">
                <div class="modal-body text-center">
                    <h3 class="text-white mb-15" style="font-size: 1.75em;"><i class="fa fa-exclamation-triangle"></i> Alert</h3>
