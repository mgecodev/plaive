        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbars-host">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item {{ $home_active }}"><a class="nav-link fontsize-header" href="{{ asset('/home') }}">홈</a></li>
                    <li class="nav-item {{ $board_active }}"><a class="nav-link fontsize-header" href="{{ asset('/MainBoard') }}">소식</a></li>
                    @if (isset($type) && $type == 'Teacher')
                        <li class="nav-item dropdown {{ $class_active }}">
                            <a class="nav-link dropdown-toggle fontsize-header" href="#" id="dropdown-a" data-toggle="dropdown">클래스</a>
                    ...
                    <li class="nav-item dropdown {{ $my_active }}">
                        <a class="nav-link dropdown-toggle fontsize-header" href="#" id="dropdown-a" data-toggle="dropdown">나의 데이터</a>
                        <div class="dropdown-menu" aria-labelledby="dropdown-a">
                    ...
                    @if (Route::has('login'))
                        @auth
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle fontsize-header" href="#" id="dropdown-a" data-toggle="dropdown">
                        ...
                        @else
                            <li class="nav-item"><a class="nav-link fontsize-header" href="#" data-toggle="modal" data-target="#login">로그인/회원가입</a>
                            </li>
                        @endauth
